...
EOF
    ...
    # Need to add Dotdeb repo for installing PHP7.0-FPM when using Debian 6.0 (squeeze)
...
function optimize_stack {
    ...
    sed -i 's/^listen =.*/listen = \/var\/run\/php\/php7.0-fpm-www-data.sock/' $php_fpm_conf
